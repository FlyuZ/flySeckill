...
function load_day_1(){
    //1.获取年
    var y=document.getElementById("year_1");
    var m=document.getElementById("month_1");
    var d=document.getElementById("day_1");
    //刷新每月的天数
...
function load_day_2(){
    //1.获取年
    var y=document.getElementById("year_2");
    var m=document.getElementById("month_2");
    var d=document.getElementById("day_2");
    //刷新每月的天数
    d.innerHTML = "<option>请选择</option>";
